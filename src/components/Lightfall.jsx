...
export default function Lightfall({
  ...
  useEffect(() => {
    ...
    const io = new IntersectionObserver(
      entries => { offScreenRef.current = !entries[0].isIntersecting; },
      { threshold: 0 }
    );
    ...
    const loop = t => {
      ...
      if (paused || offScreenRef.current) return;
  ...
  }, [dpr, fps, paused, colors, backgroundColor, speed, streakCount, streakWidth, streakLength,
